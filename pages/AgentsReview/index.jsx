        ...
        <div className="flex flex-col md:gap-10 gap-[60px] items-start justify-start w-full">
          ...
          <div className="flex flex-col font-manrope items-center justify-start md:px-10 sm:px-5 px-8 w-full">
            <div className="flex flex-col gap-11 items-center justify-start max-w-[1200px] mx-auto w-full">
              ...
              <Text className="flex absolute justify-center items-center my-auto z-20 h-screen text-2xl font-semibold">
                Under Review
              </Text>
              <div className="bg-white-A700 border border-bluegray-100 border-solid flex md:flex-col flex-row gap-[50px] items-start justify-start p-[50px] md:px-10 sm:px-5 rounded-[10px] w-full blur-sm z-10">
