...
import BlogPageColumnactive0 from "components/BlogPageColumnactive copy";
import BlogPageColumnactive1 from "components/BlogPageColumnactive copy 2";
import BlogPageColumnactive2 from "components/BlogPageColumnactive copy 3";
import BlogPageColumnactive3 from "components/BlogPageColumnactive copy 4";
import BlogPageColumnactive4 from "components/BlogPageColumnactive copy 5";
...
const BlogPagePage = () => {
  return (
    <>
      <div className="bg-gray-51 flex flex-col items-start justify-start mx-auto w-auto sm:w-full md:w-full">
