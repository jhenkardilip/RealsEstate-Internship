...
const BlogPageColumnactive = ({ index, ...props }) => {
  console.log(index);
    ...
    <>
      <div className={props.className}>
        ...
        <div className="flex flex-row gap-2 items-center justify-start w-full">
          <Text
            className="text-gray-600 text-lg w-auto cursor-pointer"
            size="txtManropeBold18Gray600"
            onClick={() => navigate("/blogdetails0")}
          >
            {props?.active}
          </Text>
          {console.log("progsdj", props?.active)}
          <Img
            className="h-6 w-6"
...
BlogPageColumnactive.defaultProps = {
  business: "Business",
  p10delightfuldinone: "Revolutionising Real Estate Transactions",
  july202022: "Jan 15, 2024",
  time: "7 min read",
