        ...
        <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
          <div className="header-row my-px">
            <div className="flex flex-row gap-[11px] items-center justify-start">
              ...
              <Text className="text-orange-A700 text-xl w-auto">Relasto</Text>
            </div>
          ...
          <div className="flex sm:flex-1 sm:flex-col flex-row sm:hidden items-center justify-between w-[800px] sm:w-full">
            <List
              className="sm:flex-col flex-row gap-[39px] grid grid-cols-3"
